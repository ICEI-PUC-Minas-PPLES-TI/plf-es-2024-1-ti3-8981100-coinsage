...
| RF02   | O usuário deve ser capaz de visualizar os setores das criptomoedas filtrados por aqueles que possuem pelo menos 10 moedas.                                                            | Alta           | Alta             | Sprint 2   | Pronto ✅ |
| RF03   | O usuário deve ser capaz de visualizar os rankings das criptomoedas.                                                                                                                  | Alta           | Alta             | Sprint 4   | Pronto ✅        |
...
| RF07   | O usuário deve ser capaz de visualizar o preço atual da criptomoeda.                                                                                                                  | Alta           | Baixa            | Sprint 2   | Pronto ✅        |
...
| RF09   | O usuário deve ser capaz de visualizar quando ocorreu valorização no volume diário, a data e a quantidade nesse dia.                                                                  | Alta           | Alta             | Sprint 2   | Pronto ✅        |
| RF10   | O usuário deve ser capaz de visualizar a quantidade de volume diário no dia anterior à valorização de volume.                                                                         | Média          | Média            | Sprint 2   | Pronto ✅        |
| RF11   | O usuário deve ser capaz de visualizar a relação percentual entre o volume diário na valorização e o volume diário no dia anterior.                                                   | Média          | Baixa            | Sprint 2   | Pronto ✅        |
| RF12   | O usuário deve ser capaz de visualizar se houve superior a 200% nessa relação percentual do RF11.                                                                                     | Baixa          | Baixa            | Sprint 2   | Pronto ✅        |
| RF13   | O usuário deve ser capaz de visualizar o requisito RF09, RF10, RF11, RF12 no formato xlsl.                                                                                            | Alta           | Média            | Sprint 5   | Pronto ✅ |
...
| RF18   | O usuário deve ser capaz de visualizar os requisitos RF14, RF15, RF16, RF17 no formato xlsl.                                                                                          | Alta           | Média            | Sprint 4   |Pronto ✅ |
| RF19   | O usuário deve ser capaz de visualizar (xlsl) as variações de preço em períodos específicos de 1 ano, 180 dias, 90 dias, 30 dias e 7 dias.                                            | Baixa          | Média            | Sprint 3   | Pronto ✅ |
...
| RF21   | O usuário deve ser capaz de visualizar seu histórico de moedas ativas em sua carteira e os detalhes da aquisição (data, quantidade, moeda, valor de compra).                          | Alta           | Baixa            | Sprint 4   | Pronto ✅ |
| RF22   | O usuário deve ser capaz de converter suas criptomoedas ativas em sua carteira para outras moedas.                                                                                    | Baixa          | Alta             | Sprint 5   | Pronto ✅    |
| RF23   | O usuário deve ser capaz de excluir de sua carteira dados da compra de uma moeda.                                                                                                     | Alta           | Baixa            | Sprint 5   | Pronto ✅    |
| RF24   | O usuário deve ser capaz de visualizar o requisito RF21 no formato xlsx.                                                                                                              | Alta           | Alta             | Sprint 5   | Pronto ✅    |
| RF25   | O usuário deve ser capaz de visualizar(xlsl) para cada criptomoeda ativa em sua carteira os lucros (%) mensais e preço atual para cada cripto para no momento da análise da carteira. | Alta           | Alta             | Sprint 5   | Pronto ✅    |
| RF26   | O usuário deve ser capaz de visualizar(xlsl) a data (atual) da análise da carteira ao realizar download.                                                                              | Alta           | Baixa            | Sprint 5   | Pronto ✅    |

## Requisitos Não Funcionais

<!-- TODO - alterar requisito RNF02 para uma versão específica -->

| **ID** | **Descrição do Requisito**                                                                  | **Prioridade** | **Complexidade** | **Sprint** | **Pronto**   |
| ------ | ------------------------------------------------------------------------------------------- | -------------- | ---------------- | ---------- | ------------ |
| RNF01  | O sistema deve realizar a análise de todas as criptomoedas em 3 horas.                      | Baixa          | Alta             |            | Pronto ✅     |
| RNF02  | O sistema deve ser capaz de ser executado no navegador Chrome.                              | Alta           | Baixa            |            | Pronto ✅ |
...
| RNF05  | O usuário deve ser capaz de visualizar a análise do Bitcoin sempre fixa no topo da análise. | Alta           | Baixa            | Sprint 3   | Pronto ✅     |
