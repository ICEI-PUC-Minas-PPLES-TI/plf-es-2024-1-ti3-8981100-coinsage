...
| RF13   | O usuário deve ser capaz de visualizar o requisito RF09, RF10, RF11, RF12 no formato xlsl.                                                                                            | Alta           | Média            | Sprint 5   | Não Pronto (B)⚠️ |
...
| RF18   | O usuário deve ser capaz de visualizar os requisitos RF14, RF15, RF16, RF17 no formato xlsl.                                                                                          | Alta           | Média            | Sprint 4   | Não Pronto (B)⚠️ |
| RF19   | O usuário deve ser capaz de visualizar (xlsl) as variações de preço em períodos específicos de 1 ano, 180 dias, 90 dias, 30 dias e 7 dias.                                            | Baixa          | Média            | Sprint 3   | Não Pronto (B)⚠️ |
...
| RF21   | O usuário deve ser capaz de visualizar seu histórico de moedas ativas em sua carteira e os detalhes da aquisição (data, quantidade, moeda, valor de compra).                          | Alta           | Baixa            | Sprint 4   | Não Pronto (B)⚠️ |
...
| RNF02  | O sistema deve ser capaz de ser executado no navegador Chrome.                              | Alta           | Baixa            |            | Não Pronto ❌ |
