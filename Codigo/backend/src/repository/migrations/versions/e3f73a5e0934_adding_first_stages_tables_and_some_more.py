...
Revision ID: e3f73a5e0934
Revises: 2de10b4ee2f7
Create Date: 2024-04-01 09:38:00.610038
...
revision: str = "e3f73a5e0934"
down_revision: Union[str, None] = "2de10b4ee2f7"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("technical_doc", sa.ARRAY(sa.String(length=1000)), nullable=True),
