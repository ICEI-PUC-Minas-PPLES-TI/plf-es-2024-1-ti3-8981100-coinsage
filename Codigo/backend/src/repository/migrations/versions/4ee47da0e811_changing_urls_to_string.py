...
def upgrade() -> None:
    ...
    op.create_table('currencies_info_schedule',
    ...
    op.create_table('currency_base_info',
    sa.Column('uuid', sa.UUID(), nullable=False),
    ...
    op.create_table('analysis_currency_stage_four',
    sa.Column('uuid', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['uuid_analysis'], ['analysis.uuid'], ),
    sa.ForeignKeyConstraint(['uuid_currency'], ['currency_base_info.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    op.create_table('analysis_currency_stage_one',
    sa.Column('uuid', sa.UUID(), nullable=False),
    sa.Column('uuid_analysis', sa.UUID(), nullable=True),
    sa.Column('uuid_currency', sa.UUID(), nullable=True),
    ...
    op.create_table('analysis_currency_stage_three',
    sa.Column('uuid', sa.UUID(), nullable=False),
    sa.Column('uuid_analysis', sa.UUID(), nullable=True),
    sa.Column('uuid_currency', sa.UUID(), nullable=True),
    ...
    op.create_table('analysis_currency_stage_two',
    sa.Column('uuid', sa.UUID(), nullable=False),
    sa.Column('uuid_analysis', sa.UUID(), nullable=True),
    sa.Column('uuid_currency', sa.UUID(), nullable=True),
    ...
    op.create_table('setor_currency_base_info',
    sa.Column('uuid', sa.UUID(), nullable=False),
    sa.Column('uuid_setor', sa.UUID(), nullable=True),
    sa.Column('uuid_currency', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['uuid_currency'], ['currency_base_info.uuid'], ),
    sa.ForeignKeyConstraint(['uuid_setor'], ['setor.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
